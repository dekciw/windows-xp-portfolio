window.addEventListener("DOMContentLoaded", function () {
  ...
  fetch("/Start_Menu/Log_Off/Transition/Log_Off_Transition.html")
    ...
    .then((html) => {
      ...
      const shutdownSound = new Audio("/Assets/Sounds/windows-xp-shutdown.mp3");
      shutdownSound
        .play()
      ...
      setTimeout(() => {
        ...
        const powerAction = localStorage.getItem("powerAction");

        if (powerAction === "Restart") {
          setTimeout(() => {
            window.location.href = "/Loader_Login/Loader_Login.html";
          }, 2000);
        } else if (powerAction === "Turn Off") {
        ...
        localStorage.removeItem("powerAction");
      }, 3500);
    });
});
